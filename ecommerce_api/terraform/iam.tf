    ...
    Statement = [
      {
        ...
        Condition = {
          StringEquals = {
            "${aws_iam_openid_connect_provider.eks_oidc.url}:sub" = "system:serviceaccount:kube-system:ebs-csi-controller-sa"
...
data "tls_certificate" "eks_oidc" {
  url = aws_eks_cluster.ecommerce_cluster.identity[0].oidc[0].issuer
}
